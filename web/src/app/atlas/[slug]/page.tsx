...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: persona ? `${persona.name} | 贴纸人格图鉴` : "未找到人格 | 贴纸人格图鉴",
    description: persona?.oneLiner ?? "请返回贴纸人格图鉴，查看可用的人格类型。",
  };
}
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col px-4 py-6 sm:px-6">
      ...
      <section className="mt-6 grid gap-6 md:grid-cols-2">
        <div className="rounded-[28px] border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-2xl font-black text-neutral-950">三个典型特征</h2>
        ...
        <div className="rounded-[28px] border border-neutral-200 bg-white p-6 shadow-sm">
          <h2 className="text-2xl font-black text-neutral-950">别人可能这样看你</h2>
      ...
      <section className="mt-6 rounded-[28px] border border-neutral-200 bg-white p-6 shadow-sm">
        <h2 className="text-2xl font-black text-neutral-950">适合出现的贴纸场景</h2>
