...
export default function Home() {
  const pills = ["冒犯外号", "Chinlish", "造景点评", "收纳发作"];

  return (
    <main className="noise-grid mx-auto flex min-h-screen w-full max-w-6xl flex-col px-4 py-6 sm:px-6">
      <header className="flex items-center justify-between py-4">
        <div>
          <div className="text-xs font-semibold uppercase tracking-[0.3em] text-neutral-500">Sticker Persona Chaos Lab</div>
      ...
      <section className="poster-frame glow-panel sticker-card relative mt-8 overflow-hidden rounded-[44px] p-6 sm:p-10 lg:p-14">
        ...
        <div className="relative grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
          <div className="max-w-4xl">
            <div className="mono-kicker text-xs font-semibold text-neutral-500">30 题 / 5 分钟 / 娱乐测试</div>
            <h1 className="mt-6 max-w-4xl text-5xl font-black leading-[0.95] tracking-[-0.06em] text-neutral-950 sm:text-7xl lg:text-[5.4rem]">
              贴纸人格测试
              <br />
              - 你是哪种人格
            </h1>
          ...
          <div className="grid gap-4">
            <div className="glow-panel sticker-card rotate-[-4deg] overflow-hidden rounded-[30px] bg-white">
              <Image
                src={getPersonaImageSrc(featured[0])}
                alt={`${featured[0].name}人格插图`}
                width={520}
                height={360}
                priority
                className="aspect-[13/9] w-full object-cover"
              />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="glow-panel sticker-card rotate-[3deg] rounded-[28px] bg-[#fff5f8] p-5">
                <div className="text-4xl font-black text-neutral-950">27</div>
                <div className="mt-1 text-sm font-medium text-neutral-600">常规人格</div>
              </div>
              <div className="glow-panel sticker-card rotate-[-3deg] rounded-[28px] bg-[#eef6ff] p-5">
                <div className="text-4xl font-black text-neutral-950">27</div>
                <div className="mt-1 text-sm font-medium text-neutral-600">中式英语外号</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mt-10">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-2xl font-black text-neutral-950">热门人格外号</h2>
          <Link href="/atlas" className="text-sm font-medium text-neutral-700 hover:text-neutral-950">
            查看全部 27 型
          </Link>
        </div>
